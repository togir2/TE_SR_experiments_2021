...
if [ "$1" == "--query" ]; then shift; if [ "$1" == "1" ]; then echo fc00:2:0:1::1 ; fi ; if [ "$1" == "ifname (1,0) at 1" ]; then echo 1-0 ; fi ; if [ "$1" == "ifname (1,0) at 0" ]; then echo 0-0 ; fi ; if [ "$1" == "edge (1,0) at 1" ]; then echo fc00:42:0:2::1 ; fi ; if [ "$1" == "edge (1,0) at 0" ]; then echo fc00:42:0:2::2 ; fi ; if [ "$1" == "ifname (1,4) at 1" ]; then echo 1-1 ; fi ; if [ "$1" == "ifname (1,4) at 4" ]; then echo 4-0 ; fi ; if [ "$1" == "edge (1,4) at 1" ]; then echo fc00:42:0:8::2 ; fi ; if [ "$1" == "edge (1,4) at 4" ]; then echo fc00:42:0:8::1 ; fi ; if [ "$1" == "0" ]; then echo fc00:2:0:2::1 ; fi ; if [ "$1" == "ifname (0,1) at 0" ]; then echo 0-0 ; fi ; if [ "$1" == "ifname (0,1) at 1" ]; then echo 1-0 ; fi ; if [ "$1" == "edge (0,1) at 0" ]; then echo fc00:42:0:2::2 ; fi ; if [ "$1" == "edge (0,1) at 1" ]; then echo fc00:42:0:2::1 ; fi ; if [ "$1" == "ifname (0,3) at 0" ]; then echo 0-2 ; fi ; if [ "$1" == "ifname (0,3) at 3" ]; then echo 3-0 ; fi ; if [ "$1" == "edge (0,3) at 0" ]; then echo fc00:42:0:6::2 ; fi ; if [ "$1" == "edge (0,3) at 3" ]; then echo fc00:42:0:6::1 ; fi ; if [ "$1" == "ifname (0,2) at 0" ]; then echo 0-1 ; fi ; if [ "$1" == "ifname (0,2) at 2" ]; then echo 2-0 ; fi ; if [ "$1" == "edge (0,2) at 0" ]; then echo fc00:42:0:4::2 ; fi ; if [ "$1" == "edge (0,2) at 2" ]; then echo fc00:42:0:4::1 ; fi ; if [ "$1" == "3" ]; then echo fc00:2:0:3::1 ; fi ; if [ "$1" == "ifname (3,0) at 3" ]; then echo 3-0 ; fi ; if [ "$1" == "ifname (3,0) at 0" ]; then echo 0-2 ; fi ; if [ "$1" == "edge (3,0) at 3" ]; then echo fc00:42:0:6::1 ; fi ; if [ "$1" == "edge (3,0) at 0" ]; then echo fc00:42:0:6::2 ; fi ; if [ "$1" == "ifname (3,4) at 3" ]; then echo 3-1 ; fi ; if [ "$1" == "ifname (3,4) at 4" ]; then echo 4-2 ; fi ; if [ "$1" == "edge (3,4) at 3" ]; then echo fc00:42:0:c::2 ; fi ; if [ "$1" == "edge (3,4) at 4" ]; then echo fc00:42:0:c::1 ; fi ; if [ "$1" == "4" ]; then echo fc00:2:0:4::1 ; fi ; if [ "$1" == "ifname (4,1) at 4" ]; then echo 4-0 ; fi ; if [ "$1" == "ifname (4,1) at 1" ]; then echo 1-1 ; fi ; if [ "$1" == "edge (4,1) at 4" ]; then echo fc00:42:0:8::1 ; fi ; if [ "$1" == "edge (4,1) at 1" ]; then echo fc00:42:0:8::2 ; fi ; if [ "$1" == "ifname (4,3) at 4" ]; then echo 4-2 ; fi ; if [ "$1" == "ifname (4,3) at 3" ]; then echo 3-1 ; fi ; if [ "$1" == "edge (4,3) at 4" ]; then echo fc00:42:0:c::1 ; fi ; if [ "$1" == "edge (4,3) at 3" ]; then echo fc00:42:0:c::2 ; fi ; if [ "$1" == "ifname (4,2) at 4" ]; then echo 4-1 ; fi ; if [ "$1" == "ifname (4,2) at 2" ]; then echo 2-1 ; fi ; if [ "$1" == "edge (4,2) at 4" ]; then echo fc00:42:0:a::1 ; fi ; if [ "$1" == "edge (4,2) at 2" ]; then echo fc00:42:0:a::2 ; fi ; if [ "$1" == "2" ]; then echo fc00:2:0:5::1 ; fi ; if [ "$1" == "ifname (2,0) at 2" ]; then echo 2-0 ; fi ; if [ "$1" == "ifname (2,0) at 0" ]; then echo 0-1 ; fi ; if [ "$1" == "edge (2,0) at 2" ]; then echo fc00:42:0:4::1 ; fi ; if [ "$1" == "edge (2,0) at 0" ]; then echo fc00:42:0:4::2 ; fi ; if [ "$1" == "ifname (2,4) at 2" ]; then echo 2-1 ; fi ; if [ "$1" == "ifname (2,4) at 4" ]; then echo 4-1 ; fi ; if [ "$1" == "edge (2,4) at 2" ]; then echo fc00:42:0:a::2 ; fi ; if [ "$1" == "edge (2,4) at 4" ]; then echo fc00:42:0:a::1 ; fi ; exit; fi
if [ "$1" == "--stop" ]; then ip netns exec 1 bash -c "${PYTHON_CURR_DIR}/throughput.py -e -i 1.throughput.json -o 1.throughput.json" ; ip netns exec 0 bash -c "${PYTHON_CURR_DIR}/throughput.py -e -i 0.throughput.json -o 0.throughput.json" ; ip netns exec 3 bash -c "${PYTHON_CURR_DIR}/throughput.py -e -i 3.throughput.json -o 3.throughput.json" ; ip netns exec 4 bash -c "${PYTHON_CURR_DIR}/throughput.py -e -i 4.throughput.json -o 4.throughput.json" ; ip netns exec 2 bash -c "${PYTHON_CURR_DIR}/throughput.py -e -i 2.throughput.json -o 2.throughput.json" ; ip netns pids 1 | xargs kill -n 9 ; ip netns del 1 ; ip netns pids 0 | xargs kill -n 9 ; ip netns del 0 ; ip netns pids 3 | xargs kill -n 9 ; ip netns del 3 ; ip netns pids 4 | xargs kill -n 9 ; ip netns del 4 ; ip netns pids 2 | xargs kill -n 9 ; ip netns del 2 ;  exit ;  fi 
if [ "$1" == "--link" ]; then shift; if false; then :;  elif [ "$1" == "edge (1,0)" ]; then  ip netns exec 1 bash -c "ifconfig 1-0 $2 " ;  ip netns exec 0 bash -c "ifconfig 0-0 $2 " ;  elif [ "$1" == "edge (1,4)" ]; then  ip netns exec 1 bash -c "ifconfig 1-1 $2 " ;  ip netns exec 4 bash -c "ifconfig 4-0 $2 " ;  elif [ "$1" == "edge (0,1)" ]; then  ip netns exec 0 bash -c "ifconfig 0-0 $2 " ;  ip netns exec 1 bash -c "ifconfig 1-0 $2 " ;  elif [ "$1" == "edge (0,3)" ]; then  ip netns exec 0 bash -c "ifconfig 0-2 $2 " ;  ip netns exec 3 bash -c "ifconfig 3-0 $2 " ;  elif [ "$1" == "edge (0,2)" ]; then  ip netns exec 0 bash -c "ifconfig 0-1 $2 " ;  ip netns exec 2 bash -c "ifconfig 2-0 $2 " ;  elif [ "$1" == "edge (3,0)" ]; then  ip netns exec 3 bash -c "ifconfig 3-0 $2 " ;  ip netns exec 0 bash -c "ifconfig 0-2 $2 " ;  elif [ "$1" == "edge (3,4)" ]; then  ip netns exec 3 bash -c "ifconfig 3-1 $2 " ;  ip netns exec 4 bash -c "ifconfig 4-2 $2 " ;  elif [ "$1" == "edge (4,1)" ]; then  ip netns exec 4 bash -c "ifconfig 4-0 $2 " ;  ip netns exec 1 bash -c "ifconfig 1-1 $2 " ;  elif [ "$1" == "edge (4,3)" ]; then  ip netns exec 4 bash -c "ifconfig 4-2 $2 " ;  ip netns exec 3 bash -c "ifconfig 3-1 $2 " ;  elif [ "$1" == "edge (4,2)" ]; then  ip netns exec 4 bash -c "ifconfig 4-1 $2 " ;  ip netns exec 2 bash -c "ifconfig 2-1 $2 " ;  elif [ "$1" == "edge (2,0)" ]; then  ip netns exec 2 bash -c "ifconfig 2-0 $2 " ;  ip netns exec 0 bash -c "ifconfig 0-1 $2 " ;  elif [ "$1" == "edge (2,4)" ]; then  ip netns exec 2 bash -c "ifconfig 2-1 $2 " ;  ip netns exec 4 bash -c "ifconfig 4-1 $2 " ;  fi;  exit;  fi 
set -x 
...
ip link add name 2-1 type veth peer name 4-1
...
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:2::1/64 via fc00:42:0:2::2 metric 3000 src fc00:2:0:1::1'
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:3::1/64 via fc00:42:0:8::1 metric 5000 src fc00:2:0:1::1'
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:4::1/64 via fc00:42:0:8::1 metric 2000 src fc00:2:0:1::1'
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:5::1/64 via fc00:42:0:8::1 metric 3000 src fc00:2:0:1::1'
...
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:1::1/64 via fc00:42:0:2::1 metric 3000 src fc00:2:0:2::1'
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:3::1/64 via fc00:42:0:6::1 metric 3000 src fc00:2:0:2::1'
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:4::1/64 via fc00:42:0:4::1 metric 2000 src fc00:2:0:2::1'
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:5::1/64 via fc00:42:0:4::1 metric 1000 src fc00:2:0:2::1'
ip netns exec 0 bash -c 'ip -6 route add fc00:2:0:4::1 metric 1 table 1 src fc00:2:0:2::1   nexthop via fc00:42:0:2::1  encap seg6 mode inline segs fc00:2:0:1::1  weight 100 '
ip netns exec 0 bash -c 'ip -6 route add fc00:2:0:4::1 metric 1 table 1 src fc00:2:0:2::1   nexthop via fc00:42:0:6::1  encap seg6 mode inline segs fc00:2:0:3::1  weight 100 '
ip netns exec 0 bash -c 'ip -6 route add fc00:2:0:4::1 metric 1 table 1 src fc00:2:0:2::1   nexthop via fc00:42:0:4::1  encap seg6 mode inline segs fc00:2:0:5::1  weight 100 '
ip netns exec 0 bash -c 'ip -6 route add fc00:2:0:4::1 metric 1 table 1 src fc00:2:0:2::1   nexthop via fc00:42:0:4::1  encap seg6 mode inline segs fc00:2:0:5::1  weight 100 '
ip netns exec 0 bash -c 'ip -6 rule add to fc00:2:0:4::1/64 iif lo table 1'
ip netns exec 0 bash -c 'ip -6 rule add to fc00:2:0:4::1/64 iif lo table 1'
ip netns exec 0 bash -c 'ip -6 rule add to fc00:2:0:4::1/64 iif lo table 1'
ip netns exec 0 bash -c 'ip -6 rule add to fc00:2:0:4::1/64 iif lo table 1'
ip netns exec 0 bash -c 'echo bash -c \"START=\\\$SECONDS\; while \! ip netns exec 0 nuttcp -T150 -i1 -R40000 -N16 fc00:2:0:4::1 \>\>flow_0-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\$SECONDS \>\>flow_0-4.txt\; done\" | at now+2min'
ip netns exec 0 bash -c 'echo bash -c \"START=\\\$SECONDS\; while \! ip netns exec 0 nuttcp -T150 -i1 -R40000 -N16 fc00:2:0:4::1 \>\>flow_0-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\$SECONDS \>\>flow_0-4.txt\; done\" | at now+2min'
ip netns exec 0 bash -c 'echo bash -c \"START=\\\$SECONDS\; while \! ip netns exec 0 nuttcp -T150 -i1 -R40000 -N16 fc00:2:0:4::1 \>\>flow_0-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\$SECONDS \>\>flow_0-4.txt\; done\" | at now+2min'
ip netns exec 0 bash -c 'echo bash -c \"START=\\\$SECONDS\; while \! ip netns exec 0 nuttcp -T150 -i1 -R40000 -N16 fc00:2:0:4::1 \>\>flow_0-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\$SECONDS \>\>flow_0-4.txt\; done\" | at now+2min'
...
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:1::1/64 via fc00:42:0:c::1 metric 5000 src fc00:2:0:3::1'
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:2::1/64 via fc00:42:0:6::2 metric 3000 src fc00:2:0:3::1'
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:4::1/64 via fc00:42:0:c::1 metric 3000 src fc00:2:0:3::1'
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:5::1/64 metric 4000 src fc00:2:0:3::1 nexthop via fc00:42:0:6::2 weight 1 nexthop via fc00:42:0:c::1 weight 1 '
...
ip netns exec 4 bash -c 'tc class add dev 4-2 parent 1: classid 1:1 htb rate 40000kbit ceil 40000kbit'
...
ip netns exec 4 bash -c 'ip -6 ro ad fc00:2:0:1::1/64 via fc00:42:0:8::2 metric 2000 src fc00:2:0:4::1'
ip netns exec 4 bash -c 'ip -6 ro ad fc00:2:0:2::1/64 via fc00:42:0:a::2 metric 2000 src fc00:2:0:4::1'
ip netns exec 4 bash -c 'ip -6 ro ad fc00:2:0:3::1/64 via fc00:42:0:c::2 metric 3000 src fc00:2:0:4::1'
ip netns exec 4 bash -c 'ip -6 ro ad fc00:2:0:5::1/64 via fc00:42:0:a::2 metric 1000 src fc00:2:0:4::1'
...
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:1::1/64 via fc00:42:0:a::1 metric 3000 src fc00:2:0:5::1'
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:2::1/64 via fc00:42:0:4::2 metric 1000 src fc00:2:0:5::1'
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:3::1/64 metric 4000 src fc00:2:0:5::1 nexthop via fc00:42:0:4::2 weight 1 nexthop via fc00:42:0:a::1 weight 1 '
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:4::1/64 via fc00:42:0:a::1 metric 1000 src fc00:2:0:5::1'
